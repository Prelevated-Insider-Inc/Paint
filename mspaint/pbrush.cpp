...
#ifdef UNICODE
        // Display the error code in a MessageBox using MessageBoxW
        MessageBoxW(
            NULL,
...
#else
        // Display the error code in a MessageBox using MessageBoxA
        MessageBoxA(
            NULL,
            (LPCSTR)((_T("DialogBoxParam failed, error code: ") + std::to_string(error)).c_str()),
            "Error",
            MB_OK | MB_ICONERROR
        );
#endif
